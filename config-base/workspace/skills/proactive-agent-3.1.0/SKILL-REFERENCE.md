...
> ⚠️ **注意**: WAL 协议、Working Buffer、Memory 管理、安全规则等核心内容以 `AGENTS.md` 为权威来源（Bootstrap 时必读）。本技能仅保留增量补充内容（Compaction Recovery、Autonomous Crons、Tool Migration 等）。如有冲突，以 `AGENTS.md` 为准。
