...
function printUsage() {
  const lines = [
    "Usage:",
    "  node scripts/feishu_agent_runtime.mjs create --type flight --query '{\"from\":\"SHA\",\"to\":\"SZX\"}' --platforms feizhu,qunar,ctrip,meituan --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs advance --task <task_id> --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs collect --task <task_id> --urls '[{\"source\":\"ctrip\",\"url\":\"https://...\"}]' --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs auto-compare --task <task_id> --urls '[{\"source\":\"ctrip\",\"url\":\"https://...\"}]' --item-selector '.item-card' --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs set-anchor --task <task_id> --keyword '特仑苏' --brand '蒙牛' --spec '250ml*24' --pack-count 24 --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs same-report --task <task_id> --threshold 0.78 --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs auto-compare-same --task <task_id> --urls '[{\"source\":\"jd\",\"url\":\"https://...\"}]' --spec '250ml*24' --threshold 0.78 --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs ingest --task <task_id> --files '/tmp/a.png,/tmp/b.png' --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs ocr-extract --task <task_id> --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs extract --task <task_id> --offers '[{\"source\":\"ctrip\",\"final_price\":1280}]' --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs rank --task <task_id> --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs draft --task <task_id> --offer <offer_id> --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs risk-check --task <task_id> --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs final-check --task <task_id> --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs force-release --task <task_id> --operator __YOUR_NAME__",
    "  node scripts/feishu_agent_runtime.mjs cmd --text 'CONFIRM_SUBMIT <task_id>' --operator __YOUR_NAME__",
